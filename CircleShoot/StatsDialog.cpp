...
void StatsDialog::Draw(Graphics *g)
{
    ...
    if (!mIsGameOver)
    {
		...
		g->DrawString(std::to_string(mScore), aCol2, aDialogTop);
        g->DrawString(std::to_string(mBoard->mLevelStats.mNumCombos), aCol2, aDialogTop + aLineOffset);
        g->DrawString(std::to_string(mBoard->mLevelStats.mNumGemsCleared), aCol2, aDialogTop + 2 * aLineOffset);
        g->DrawString(std::to_string(mBoard->mLevelStats.mNumGaps), aCol2, aDialogTop + 3 * aLineOffset);
        g->DrawString(std::to_string(mBoard->mLevelStats.mMaxInARow), aCol2, aDialogTop + 4 * aLineOffset);
        g->DrawString(std::to_string(mBoard->mLevelStats.mMaxCombo + 1), aCol2, aDialogTop + 5 * aLineOffset);
    ...
    else
    {
        ...
        g->DrawString(std::to_string(mBoard->mGameStats.mNumCombos), aColLeft, aDialogTop + aLineOffset);
        g->DrawString(std::to_string(mBoard->mGameStats.mNumGemsCleared), aColLeft, aDialogTop + 2 * aLineOffset);
        g->DrawString(std::to_string(mBoard->mGameStats.mNumGaps), aColRight, aDialogTop);
        g->DrawString(std::to_string(mBoard->mGameStats.mMaxInARow), aColRight, aDialogTop + aLineOffset);
        g->DrawString(std::to_string(mBoard->mGameStats.mMaxCombo + 1), aColRight, aDialogTop + 2 * aLineOffset);
