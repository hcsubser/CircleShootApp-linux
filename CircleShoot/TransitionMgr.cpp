...
void LetterStamp::CreateImage()
{
    ...
    _Font *aFont = Sexy::GetFontById((ResourceId)mFont);
...
void TransitionMgr::DrawLetterStamp(Graphics *g)
{
    for (LetterStampList::iterator anItr = mLetterStampList.begin(); anItr != mLetterStampList.end(); anItr++)
    {
        ...
        _Font *aFont = Sexy::GetFontById((ResourceId)aStamp.mFont);
...
void TransitionMgr::DrawTextBlurb(Graphics *g)
{
         ...
         anItr++)
    {
        ...
        if (aCharNum > 0)
        {
            ...
            _Font *aFont = Sexy::GetFontById((ResourceId)aBlurb.mFont);
            g->SetFont(aFont);
...
{
    _Font *aFont = Sexy::GetFontById(Sexy::FONT_DIALOG_ID);
...
void TransitionMgr::DoLevelBegin(bool firstTime)
{
    ...
    _Font *aFont = Sexy::GetFontById(Sexy::FONT_BROWNTITLE_ID);
...
void TransitionMgr::DoStageComplete()
{
    ...
    Sexy::_Font *aFont = Sexy::FONT_HUGE;
